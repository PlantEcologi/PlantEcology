...
::::: columns
::: {.column width="65%"}
### We will provide the tools to build predictive theory and make accurate forecasts of biodiversity and Nature's Contributions to People.
:::
...
##  {background-video="img/SimonsFig1.mov" background-video-muted="true" background-size="contain"}
...
::::: columns
::: {.column width="65%"}
### Providing the tools to build predictive theory and make accurate forecasts of biodiversity and Nature's Contributions to People.
:::
